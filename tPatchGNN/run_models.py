...
if __name__ == '__main__':
	...
	# --- Adjusted optimizer: higher LR for attention fusion ---
	if hasattr(model, "scale_fuser") and model.scale_fuser is not None:
	    optimizer = optim.Adam([
	        {"params": model.parameters()},
	        {"params": model.scale_fuser.parameters(), "lr": args.lr * 5}  # 5× higher LR for fuser
